...
\begin{figure}[htb]
        \centering
        \includegraphics[width = 0.7\textwidth]{figures/Centralloss.jpg} % scale, width, height 
...
\subsection{OCT Voxels Segmentation}
